...
public class CameraSource {
        ...
        synchronized (cameraLock) {
            ...
            if (processingThread != null) {
                try {
                    ...
                    //.d(TAG, "Frame processing thread interrupted on release.");
                }
            ...
            if (camera != null) {
                ...
                try {
                    ...
                    //.e(TAG, "Failed to clear camera preview: " + e);
                }
                camera.release();
                camera = null;
            }
    ...
    public int doZoom(float scale) {
        synchronized (cameraLock) {
            ...
            if (!parameters.isZoomSupported()) {
                //.w(TAG, "Zoom is not supported on this device");
                return currentZoom;
            }
    ...
    private Camera createCamera() {
        ...
        if (focusMode != null) {
            if (parameters.getSupportedFocusModes().contains(
                ...
                //.i(TAG, "Camera focus mode: " + focusMode +
        ...
        if (flashMode != null) {
            if (parameters.getSupportedFlashModes().contains(
                ...
                //.i(TAG, "Camera flash mode: " + flashMode +
                 //       " is not supported on this device.");
            }
        }
    ...
    private static List<SizePair> generateValidPreviewSizeList(Camera camera) {
        ...
        if (validPreviewSizes.size() == 0) {
            //.w(TAG, "No preview sizes have a corresponding same-aspect-ratio picture size");
            for (android.hardware.Camera.Size previewSize : supportedPreviewSizes) {
    ...
    private void setRotation(Camera camera, Camera.Parameters parameters, int cameraId) {
        ...
        switch (rotation) {
            ...
            case Surface.ROTATION_270:
                ...
                break;
            default:
                //.e(TAG, "Bad rotation value: " + rotation);
        }
                ...
                synchronized (mLock) {
                    while (mActive && (mPendingFrameData == null)) {
                        try {
                            ...
                            //.d(TAG, "Frame processing loop terminated.", e);
                            return;
                        }
                    }
